...
CREATE TABLE `Domtec` (
  ...
  `desc_tec` varchar(150) COLLATE utf8_spanish_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
...
CREATE TABLE `Trabajos` (
  ...
  `jefe_trabajo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `sigue_trabajo` varchar(2) COLLATE utf8_spanish_ci DEFAULT NULL,
  `tiempo_trabajo` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL,
